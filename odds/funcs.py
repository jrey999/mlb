...
HOST, APIKEY = "https://api.the-odds-api.com", config.get("APIKEY")
...
def get_markets() -> list[dict]:
    ...
    return [game for game in requests.get(HOST + MARKETS.format(APIKEY)).json() if datetime.datetime.now(get_localzone()) > iso_to_dt(game["commence_time"])]
